...
class ScatterMatrixTab(BaseGraphTab):
    """Tab for scatter matrix visualization"""
    def __init__(self, context: AppContext):
        super().__init__(name="Scatter Matrix", context=context)

    def draw(self):
        """Draw scatter matrix plot for multivariate data visualization."""
        self.clear()
        ...
        renderer = RENDERERS['scatter_matrix']
        renderer.render(
            self.ax,
            dataframe,
        )
